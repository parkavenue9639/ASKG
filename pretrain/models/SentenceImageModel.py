...
class OpenAIGPTConfig(object):
    ...
    def __init__(
        ...
        att_feat_size=1024,
        n_ann=49,
        tag_decoderdir="../../../data/processed_fh21_precise_tag/tagdecoder.pkl",
    ):
...
class SentenceLMHeadModel(OpenAIGPTPreTrainedModel):
    ...
    def _sample(self, att_feats):
        ...
        for i in range(self.seq_sent_length - 1):
            hidden_states = self.decoder(ys, None, None, tag_hidden_states)
